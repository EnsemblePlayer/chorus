				...
				<div style="position: fixed; top: 0; width: 100%;">
					<div style="background: #333; height: 50px; padding: 15px;">
						<div>
							...
							<a style="text-decoration: none; color: #f2f2f2; font-size: 14px; font-weight: 300; padding-left: 10px; padding-right: 10px; border-bottom-style: solid; border-bottom-color: #e91e63;" href="music.php">Music</a>
